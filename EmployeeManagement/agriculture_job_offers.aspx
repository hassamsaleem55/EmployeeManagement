<%@ Page Title="Agriculture Job Offers" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="agriculture_job_offers.aspx.cs" Inherits="EmployeeManagement.agriculture_job_offers" %>
    ...
    <script>
        $(document).ready(function () {
            ...
            function getClosedJobOffers() {
                ...
                var arrData = [];
                $.ajax({
                    url: localStorage.getItem("ApiLink") + "api/agriculture_job_offers_closed",
                    async: false,
                    method: 'GET',
                    success: function (data) {
                        $(data).each(function (index, value) {
