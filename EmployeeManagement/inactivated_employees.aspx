<%@ Page Title="Inactive Employees" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="inactivated_employees.aspx.cs" Inherits="EmployeeManagement.Inactivated_employees" %>
     ...
     <div id="modalBlacklist" class="modal fade" role="dialog">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-dark" data-dismiss="modal">Close</button>
                    <button type="button" class="btn btn-success" data-dismiss="modal">Activate</button>
                </div>
            </div>
        </div>
    </div>
    ...
    <script>
        $(document).ready(function () {
            ...
            function getEmployeesData() {
                ...
                $(".table-responsive").html('<table id="example" class="table table-striped table-bordered table-hover" style="width: 100%;"><thead><tr><th>#</th><th>First Name</th><th>Last Name</th><th>NIF Number</th><th>Email</th><th>Password</th><th>Contact</th><th>Documents</th><th>Comments</th><th class="text-center">Actions</th></tr></thead></table>');
                $('#example').DataTable({
                    "data": arrData,
                    "columns": [
                        { "data": "sr" },
            ...
            $(document).on("click", ".viewComments", function () {
                $("#modalComments .modal-title").html("Why " + $(this).attr("data-name") + " was inactivated ?");
