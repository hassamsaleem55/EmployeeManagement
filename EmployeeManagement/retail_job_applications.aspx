<%@ Page Title="Retail Job Applications" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="retail_job_applications.aspx.cs" Inherits="EmployeeManagement.retail_job_applications" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
            <div class="main">
        <div class="panel">
            <div class="panel-heading">
                <h3>Retail Job Applications</h3>
            </div>
    ...
    <script>
        ...
        $(document).ready(function () {
            ...
            function getPendingApplicants() {
                ...
                var arrData = [];
                $.ajax({
                    url: localStorage.getItem("ApiLink") + "api/retail_job_applications_new",
                    async: false,
                    method: 'GET',
            ...
            function getApprovedApplicants() {
                ...
                var arrData = [];
                $.ajax({
                    url: localStorage.getItem("ApiLink") + "api/retail_job_applications_approved",
                    async: false,
                    method: 'GET',
                    success: function (data) {
                        $(data).each(function (index, value) {
            ...
            function getRejectedApplicants() {
                ...
                var arrData = [];
                $.ajax({
                    url: localStorage.getItem("ApiLink") + "api/retail_job_applications_rejected",
                    async: false,
                    method: 'GET',
                    success: function (data) {
                        $(data).each(function (index, value) {
