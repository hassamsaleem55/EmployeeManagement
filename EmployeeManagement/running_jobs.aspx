                    ...
                    success: function (data) {
                        ...
                        if (data.length != 0) {
                            $(data).each(function (index, value) {
                                $("#rowJobsTable").append("<tr><td>" + (index + 1) + "</td><td>" + value.job_title + "</td><td>" + value.client_name + "</td><td>" + getFormatedDate(value.job_end_date) + "</td><td>" + value.job_shift + "</td><td>" + value.job_type + "</td><td><a id='btnViewLabors' style='cursor: pointer;' data-id='" + value.job_id + "'>View</a></td><td><a id='btnViewDetails' style='cursor: pointer;' data-id='" + value.job_id + "'>View</a></td><tr>");
                                    });
                                    }
                        else {
